<template>
	<div class="grid items-center">
		<div class="flex flex-col gap-4">
			<div
				class="flex flex-row h-14 rounded-lg bg-usach-ultra-900 align-middle items-center"
			>
				<div
					...
					<button
						...
						:class="{
							'bg-usach-ultra-300 font-usach-bebas-body':
								store.respuestas[num] === undefined,
			...
			<div
				class="flex flex-col rounded-lg bg-usach-ultra-900 p-10 text-center font-usach-helvetica-body text-white items-center"
			>
				<div class="font-usach-helvetica-bold text-lg">
					Pregunta {{ i + "/" + cantPregs }}
				</div>
				<div
					class="bg-usach-ultra-600 text-7xl p-3 rounded-lg my-5 font-usach-helvetica-bold"
				>
				...
				<div
					class="flex flex-row p-5 rounded-lg bg-usach-ultra-600 mt-3 mb-7"
				>
				...
				<div
					class="flex flex-row justify-center gap-4 font-usach-bebas-body"
				>
					<button
						v-if="i > 1"
						@click="prevQuestion"
						class="bg-usach-aqua-800 rounded-lg p-2"
					>
						Atrás
					</button>
					<button
