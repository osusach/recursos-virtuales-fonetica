<template>
    <div v-if="!loading" class="w-full sm:w-fit flex flex-col gap-4">
        ...
        <div class="flex flex-col rounded-lg bg-usach-ultra-900 p-10 text-center font-usach-helvetica-body text-white items-center">
            ...
            <p v-if="dificultad !== 1" class="text-center text-xl">¿Qué tipo de rima se presenta entre las siguientes palabras?</p>
            <p v-if="dificultad === 1" class="text-center text-xl">¿Hay rima entre las siguientes palabras?</p>
            <div class="preguntas">
...
const changeQuestionApi = () => {
    ...
    palabra0.value = question.wordA
    palabra1.value = question.wordB
