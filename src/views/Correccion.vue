<template>
	<div
		class="flex flex-col gap-y-2 text-center bg-usach-aqua-300 rounded-lg p-5 font-usach-bebas-body"
	>
		...
		<div
			class="flex flex-row rounded-lg gap-1 justify-center text-xl bg-usach-terra-700"
		>
			<p class="">{{ puntaje }}</p>
			<p>puntos</p>
		</div>
		<div
			class="flex flex-col bg-usach-aqua-100 h-7 w-[100%] rounded-lg mb-4"
		>
			<div
				class="flex h-7 rounded-lg items-center justify-center align-middle"
			...
			>
				<p
					class="font-usach-bebas-body text-xl"
					:class="{
		...
		<div
			v-for="(item, index) in correccion"
			class="flex flex-row place-content-between bg-usach-aqua-800 rounded-lg py-2 px-4 gap-x-6"
			:class="{
		...
		>
			...
			<div class="flex flex-col text-center">
				<p
					class="font-usach-bebas-body text-lg rounded-lg"
					:class="{
